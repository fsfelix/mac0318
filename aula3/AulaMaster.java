...
public class AulaMaster {
	...
	private static final String NXT_ID = "NXT15"; // NXT BRICK NAME
	/**
	...
	public static void main(String[] args) {
		...
		master.connect(); // tries to connect with slave
	   	...
	   	while(true) {
	    		System.out.print("Enter command [0:Forward 1:Stop 2:Exit 3:Backward 4:Turn Left 5:Turn Right]: "); //print available commands
	    		cmd = (byte) scan.nextFloat(); // read (command) float and converts it to byte
	    		if (cmd == 0) { // if Forward is selected, define speed

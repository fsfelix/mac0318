...
public class widthSearch {
    ...
    public static ArrayList <coord> frenteDeOnda(int SR, Point pointInit, Point pointGoal, boolean linearize, boolean thicken) {
        ArrayList <coord> path = new ArrayList <coord> ();
...
*/
    public static void main(String[] args) {
        ...
        path = frenteDeOnda(40, points[0], points[10], false, false);
